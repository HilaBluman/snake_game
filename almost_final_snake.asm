...
; --------------------------
	...
	explantion4 db "into itself. The game will end if the snake hits a wall or its self.$"
   ...
   reet dw ?
	...
	;apple
	numApple dw 00
	appleX dw 100, 40, 60, 260, 100, 50, 75, 214, 240, 175, 80, 240, 35, 90, 70, 150, 110, 40, 125, 69 ; there are 20 options
	appleY dw 40, 80, 30, 20, 45, 130, 85, 90, 170, 90, 50, 140, 60, 35, 120, 40, 100, 70, 80, 175, 69 ; there are 20 options
	addSnake dw 0
	placeApple dw 00
	score db 00
